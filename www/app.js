...
app.run(function ($ionicPlatform, EventService, utilityService, $rootScope, $cordovaToast) {
    ...
    .config(function ($stateProvider, $urlRouterProvider, $translateProvider, $httpProvider) {
        ...
        $stateProvider
            ...
            .state('userAgreement', {
                url: '/userAgreement',
                templateUrl: 'components/signup/views/userAgreement.html',
            ...
            .state('verifyAccount', {
                url: '/verify-account',
                params: {isFromLogin: false, indirect: false, credential: null},
        ...
        $urlRouterProvider.otherwise('userCredential');
